...
public class MyGame extends VariableFrameRateGame {
    ...
    private boolean soundEnabled = false;     // Track if sound is enabled or not
    ...
    public void loadSounds() {
        ...
        try {
            resource1 = audioMgr.createAudioResource("pendulum_whoosh.wav", AudioResourceType.AUDIO_SAMPLE);
            resource2 = audioMgr.createAudioResource("splash.wav", AudioResourceType.AUDIO_SAMPLE);
            resource3 = audioMgr.createAudioResource("victory.wav", AudioResourceType.AUDIO_SAMPLE);
            resource4 = audioMgr.createAudioResource("ocean.wav", AudioResourceType.AUDIO_STREAM);
...
public void update() {
    ...
    if (physicsRunning) {
        ...
        if (movementKeyPressed) {
            ...
            newTransform[0] = 1.0; newTransform[1] = 0.0; newTransform[2] = 0.0; newTransform[3] = 0.0;
            newTransform[4] = 0.0; newTransform[5] = 1.0; newTransform[6] = 0.0; newTransform[7] = 0.0;
            newTransform[8] = 0.0; newTransform[9] = 0.0; newTransform[10] = 1.0; newTransform[11] = 0.0;
    ...
    private void updateSounds() {
        if (audioMgr == null || !soundEnabled) return;  // Skip sound updates if disabled
    ...
    private void updateCameraPosition() {
        ...
        // Calculate camera position: dolphin position + (backDir * distance) + (up * height)
