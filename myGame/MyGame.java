...
public class MyGame extends VariableFrameRateGame
{
    ...
    // shapes
    private ObjShape waterPlaneShape, cubeShape, sphereShape, torusShape;
    ...
    public void update()
    {
        ...
        // build and set HUD - combine time and connection status in HUD1, keep keyboard hits in HUD2
